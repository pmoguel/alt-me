...
export default function WorkContent() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pt-32 pb-24 md:pt-24 md:pb-16">
      <h1 className="text-4xl font-bold mb-8 text-gray-800 dark:text-gray-200">{t.pages.work.title}</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <a href="/different-realities" className="group relative overflow-hidden rounded-lg shadow-lg transition-transform hover:scale-105">
          ...
          <div className="absolute inset-0 flex items-end p-6">
            ...
            <div className="relative text-white">
              <h2 className="text-2xl font-bold mb-2 group-hover:text-fuchsia-400 transition-colors">{t.pages.work.photoProject.title}</h2>
        ...
        <a href="/araucaria" className="group relative overflow-hidden rounded-lg shadow-lg transition-transform hover:scale-105">
          ...
          <div className="absolute inset-0 flex items-end p-6">
            <div className="absolute bottom-0 left-0 right-0 h-1/4 bg-gradient-to-t from-black/95 via-black/80 via-black/60 via-black/40 to-transparent backdrop-blur-[12px]"></div>
            <div className="relative text-white">
              <h2 className="text-2xl font-bold mb-2 group-hover:text-fuchsia-400 transition-colors">{t.pages.work.animationProject.title}</h2>
        ...
        <a href="/cubos" className="group relative overflow-hidden rounded-lg shadow-lg transition-transform hover:scale-105">
          ...
          <div className="absolute inset-0 flex items-end p-6">
            <div className="absolute bottom-0 left-0 right-0 h-1/4 bg-gradient-to-t from-black/95 via-black/80 via-black/60 via-black/40 to-transparent backdrop-blur-[12px]"></div>
            <div className="relative text-white">
              <h2 className="text-2xl font-bold mb-2 group-hover:text-fuchsia-400 transition-colors">{t.pages.work.objectProject.title}</h2>
        ...
        <a href="/" className="group relative overflow-hidden rounded-lg shadow-lg transition-transform hover:scale-105">
          ...
          <div className="absolute inset-0 flex items-end p-6">
            <div className="absolute bottom-0 left-0 right-0 h-1/4 bg-gradient-to-t from-black/95 via-black/80 via-black/60 via-black/40 to-transparent backdrop-blur-[12px]"></div>
            <div className="relative text-white">
              <h2 className="text-2xl font-bold mb-2 group-hover:text-fuchsia-400 transition-colors">{t.pages.work.webProject.title}</h2>
